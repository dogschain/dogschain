...
// MsgDogsChain implements a cosmos equivalent structure for Ethereum transactions
type MsgDogsChain struct {
...
func (msg MsgDogsChain) String() string {
...
func (msg MsgDogsChain) Route() string { return RouterKey }

// Type returns the action of the message
func (msg MsgDogsChain) Type() string { return TypeMsgDogsChain }

// GetSignBytes encodes the message for signing
func (msg MsgDogsChain) GetSignBytes() []byte {
	return sdk.MustSortJSON(ModuleCdc.MustMarshalJSON(msg))
}

// ValidateBasic runs stateless checks on the message
func (msg MsgDogsChain) ValidateBasic() error {
	if msg.Price.IsZero() {
...
func (msg MsgDogsChain) GetSigners() []sdk.AccAddress {
	return []sdk.AccAddress{msg.From}
}

// To returns the recipient address of the transaction. It returns nil if the
// transaction is a contract creation.
func (msg MsgDogsChain) To() *ethcmn.Address {

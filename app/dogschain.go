...
import (
	...
	"github.com/dogschain/dogschain/app/ante"
	dogschaincodec "github.com/dogschain/dogschain/app/codec"
...
const appName = "DogsChain"

var (
	// DefaultCLIHome sets the default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.dogschaincli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.dogschaind")
...
func NewDogsChainApp(
	...
	cdc := dogschaincodec.MakeCodec(ModuleBasics)

	// NOTE we use custom DogsChain transaction decoder that supports the sdk.Tx interface instead of sdk.StdTx
...
func (app *DogsChainApp) Name() string { return app.BaseApp.Name() }

...
// SupportedAlgorithms defines the list of signing algorithms used on DogsChain:
...
func EthSecp256k1Options() []keys.KeybaseOption {
	return []keys.KeybaseOption{
		keys.WithKeygenFunc(DogsChainKeygenFunc),
...
// DogsChainKeygenFunc is the key generation function to generate secp256k1 ToECDSA
// from ethereum.
func DogsChainKeygenFunc(bz []byte, algo keys.SigningAlgo) (tmcrypto.PrivKey, error) {

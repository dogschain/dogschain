...
import (
	...
	ethcdc "github.com/dogschain/dogschain/app/codec"
)
...
// file.
func (app *DogsChainApp) ExportAppStateAndValidators(
...
func (app *DogsChainApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {

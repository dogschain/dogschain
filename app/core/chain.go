...
// transactions. There should only be a single implementation in DogsChain. For
// the purposes of DogsChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: DogsChain will distribute the fees out to validators, so the structure

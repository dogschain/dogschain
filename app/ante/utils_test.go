...
import (
	...
	ante "github.com/dogschain/dogschain/app/ante"
...
func newTestCoins() sdk.Coins {
	return sdk.NewCoins(dogschain.NewPhotonCoinInt64(500000000))
}

func newTestStdFee() auth.StdFee {
	return auth.NewStdFee(220000, sdk.NewCoins(dogschain.NewPhotonCoinInt64(150)))
}

...
import (
	...
	"github.com/dogschain/dogschain/app/types"
)
...
func (suite *AccountTestSuite) TestEthAccount_Balance() {
	...
	testCases := []struct {
		...
		{"positive diff", types.AttoDogs, sdk.Coins{}, sdk.OneInt()},
		{"zero diff, same coin", types.AttoDogs, sdk.NewCoins(types.NewPhotonCoin(sdk.ZeroInt())), sdk.ZeroInt()},
		{"zero diff, other coin", sdk.DefaultBondDenom, sdk.NewCoins(types.NewPhotonCoin(sdk.ZeroInt())), sdk.ZeroInt()},
		{"negative diff", types.AttoDogs, sdk.NewCoins(types.NewPhotonCoin(sdk.NewInt(10))), sdk.NewInt(1)},
	}
...
func (suite *AccountTestSuite) TestDogsChainAccountJSON() {
...
func (suite *AccountTestSuite) TestDogsChainPubKeyJSON() {
...
func (suite *AccountTestSuite) TestDogsChainAccount_String() {
...
func (suite *AccountTestSuite) TestDogsChainAccount_MarshalJSON() {
